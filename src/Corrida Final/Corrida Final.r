...
envg$EXPENV <- list()
envg$EXPENV$dir <- "~/buckets/b1/final/"
envg$EXPENV$exp_dir <- "~/buckets/b1/final/exp/"
envg$EXPENV$wf_dir <- "~/buckets/b1/final/flow/"
...
TS_strategy_baseline_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202002, 202001, 201912, 
                               201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901)
  
  param_local$train$training <- c(202105, 202104, 202103, 202102, 202101, 202012, 202002, 202001, 201912, 201911, 201910, 
                                  201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901)
...
ZZ_final_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$kaggle$envios_desde <-  10600L
  param_local$kaggle$envios_hasta <- 11400L
  param_local$kaggle$envios_salto <-   200L
  
  # para el caso que deba graficar
  param_local$graficar$envios_desde <-  10000L
