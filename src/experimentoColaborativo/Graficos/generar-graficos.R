...
# Inicializo variables del environment global
envg$EXPENV <- list()
...
graficar_experimento <- function(experimento) {
  ...
  # Salvar los graficos 
  ggsave(filename = paste0("experimento_", experimento, "_semillas.png"), plot = plot_semilla, path = envg$EXPENV$dir , width = 10, height = 6)
  ggsave(filename = paste0("experimento_", experimento, "_pca.png"), plot = plot_pca, path = envg$EXPENV$dir , width = 10, height = 6)
  ggsave(filename = paste0("experimento_", experimento, "_dual.png"), plot = plot_dual, path = envg$EXPENV$dir , width = 10, height = 6)
...
graficar_promedios <- function() {
  ...
  # Salvar los graficos 
  ggsave(filename = "promedio_resultados_exp.png", plot = promedios_exp, path = envg$EXPENV$dir , width = 10, height = 6)
  ggsave(filename = "promedio_resultados_pca.png", plot = promedios_pca, path = envg$EXPENV$dir , width = 10, height = 6)
